...
def render():
    ...
    # compute the actual data bounds
    ...
    # first row: Median Income, Private Schools, Vessel Count
    ...
    # second row: Homes > $1M, Home Value Growth, Divorce Rate
    ...
    with st.container():
        ...
        with table_col:
            ...
            topn = filtered.nlargest(n, "Wealth Score")[[
                "Rank","ZIP Code","Area",
                "Real_Median_Income","Real_Divorce_Rate",
